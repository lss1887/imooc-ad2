...
import com.imooc.ad.dao.unit_condition.CreativeUnitReposity;
...
public class DumpDataService {
    ...
    @Autowired
    private CreativeUnitReposity creativeUnitReposity;
    @Autowired
    private AdUnitDistrictRepository districtRepository;
    @Autowired
    private AdUnitItReposity itReposity;
    @Autowired
    ...
    public void dumpAdTableData(){
        ...
        dupmAdUnitTable(String.format("%s%s", DConstant.DATA_ROOT_DIR,DConstant.AD_UNIT));
    ...
    private void dupmAdUnitTable(String fileName){
        ...
        try {
            ...
            log.error("dupmAdUnitTable error ==> ",e);
        }
    }
    ...
    private  void dumpAdCreativeUnitTable(String fileName){
        ...
        List<CreativeUnit> creativeUnits = creativeUnitReposity.findAll();
    ...
    private void dumpAdUnitItTable(String fileName){
        List<AdUnitIt> unIts = itReposity.findAll();
        if(CollectionUtils.isEmpty(unIts)){
            return;
        }
        List<AdUnitItTable> unitItTables = new ArrayList<>();
        unIts.forEach(u -> unitItTables.add(
                new AdUnitItTable(
                        u.getUnitId(),
                        u.getItTag()
                )
